...
var oRM=_mz(z,'view',['class',50,'style',1],[],e,s,gg)
var xSM=_n('text')
...
var cVM=_oz(z,55,e,s,gg)
_(fUM,cVM)
_(oRM,fUM)
_(bQM,oRM)
var hWM=_n('view')
_rz(z,hWM,'class',56,e,s,gg)
var oXM=_mz(z,'uni-number-box',['bind:__l',57,'class',1,'min',2,'vueId',3],[],e,s,gg)
_(hWM,oXM)
_(bQM,hWM)
_(oLM,bQM)
_(cHM,oLM)
...
var t3M=_mz(z,'checkbox',['checked',65,'class',1,'color',2,'style',3,'value',4],[],e,s,gg)
_(a2M,t3M)
...
var hAN=_n('view')
_rz(z,hAN,'class',77,e,s,gg)
var oBN=_n('view')
_rz(z,oBN,'class',78,e,s,gg)
var cCN=_oz(z,79,e,s,gg)
_(oBN,cCN)
_(hAN,oBN)
var oDN=_n('text')
_rz(z,oDN,'class',80,e,s,gg)
var lEN=_oz(z,81,e,s,gg)
_(oDN,lEN)
_(hAN,oDN)
_(c0M,hAN)
_(x7M,c0M)
var aFN=_mz(z,'button',['class',82,'size',1,'type',2],[],e,s,gg)
var tGN=_oz(z,85,e,s,gg)
_(aFN,tGN)
_(x7M,aFN)
_(oZM,x7M)
_(cYM,oZM)
